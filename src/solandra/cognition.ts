...
const conversationPresentationOutputJsonSchema: CanonicalModelJsonSchema = Object.freeze({
  type: "object",
  properties: Object.freeze({
    conversationText: Object.freeze({ type: "string" as const }),
    composerBody: composerBodyOutputSchema,
  }),
  required: Object.freeze(["conversationText", "composerBody"]),
  additionalProperties: false,
});
    ...
    messages: [
      {
        ...
        content: [
          ...
          "The provider enforces the legal machine-readable result shape. You own the semantic values and Conversation/Composer surface placement within that shape.",
          "For CONVERSATION use the semantic shape below:",
          conversationShape,
